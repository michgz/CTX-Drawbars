...
def set_single_parameter(parameter, data, category=3, memory=3, parameter_set=0, block0=0, block1=0, block2=0):
  ...
  if isinstance(data, type(0)):
    ...
    os.write(f, make_packet(parameter_set=parameter_set, category=category, memory=memory, parameter=parameter, block=[0,block2,block1,block0], length=1))
    time.sleep(0.1)
  ...
  # Write the parameter
  os.write(f, make_packet(tx=True, parameter_set=parameter_set, category=category, memory=memory, parameter=parameter, block=[0,block2,block1,block0], length=l, data=d))
  time.sleep(0.1)
...
def get_single_parameter(parameter, category=3, memory=3, parameter_set=0, block0=0, block1=0, block2=0, length=0):
  ...
  # Read the parameter
  os.write(f, make_packet(parameter_set=parameter_set, category=category, memory=memory, parameter=parameter, block=[0,block2,block1,block0], length=l))
  time.sleep(0.1)
