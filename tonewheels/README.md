Measurements of the frequency spectrum of some possible tonewheels recordings from CT-X3000 memory. The measurement is automated using the _analyse_tonewheels.py_ script.
